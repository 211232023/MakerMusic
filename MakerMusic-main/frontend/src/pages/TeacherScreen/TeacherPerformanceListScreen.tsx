      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            <Ionicons name="bar-chart-outline" size={32} color="#f6e27f" />
        ...
        >
          {students.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>Você ainda não possui alunos cadastrados</Text>
            </View>
          ) : (
              ...
              {students.map((item) => (
                <View key={item.id.toString()} style={styles.studentCard}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => onPerformancePress(item)}
                    activeOpacity={0.8}
                  >
                    <Ionicons name="stats-chart-outline" size={20} color="#1c1b1f" />
                    <Text style={styles.performanceButtonText}>Ver Desempenho</Text>
                  </TouchableOpacity>
                </View>
              ))}
            </View>
